...
(11,LL) (7,LLL) (8,R) (5,) (4,L) (13,RL) (2,LLR) (1,RRR) (4,RR) ()  //这是一颗二叉树

(3,L) (4,R) ()   //这是另一颗二叉树，但是没有根节点，所以输出-1

样例输出：

5 4 8 11 13 4 7 2 1   //从输出结果看，这是层序遍历的输出
-1
...
//从输入样例看，能确定每个节点的位置，看到了5是根节点，剩余节点从根节点出发构建
...
main函数里就能得知输入结束）。注意这里两次用到了C语言中字符串的灵活性——可以
...
可以用静态数组配合空闲队列来实现一个简单的内存池。 虽然在大多数算
